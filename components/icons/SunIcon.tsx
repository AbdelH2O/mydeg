const SunIcon = ({ height, width, className }: { height: number, width: number, className: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.5 47.5" height={height} width={width} className={className}>
        <defs>
            <clipPath id="a">
