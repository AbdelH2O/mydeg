...
const DEFAULT_CONTEXT: {
	...
	setCurrentTerm: React.Dispatch<
		React.SetStateAction<{ type: TERMS; year: string; id: string }>
	>;
	info: {
		[key: string]: {
			name: string;
	...
	setSideBar: () => {},
	infoCourse: { id: "", name: "", credits: 0, description: "" },
	setInfoCourse: () => {},
